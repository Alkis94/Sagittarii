...
public class Pickup : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        DestroyObject(gameObject, DespawnDelay);
    }
    ...
    protected void PickupPlayerCollision()
    {
        ...
        DestroyObject(TemporaryParticleHandler);
    }
    ...
    protected void PickupGroundCollision()
    {
        ...
        DestroyObject(TemporaryParticleHandler, DestroyTemporaryParticleHandlerTimer);
    }
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        else if (other.tag == "Platform" && PlayerNotPickedUp)
        {
